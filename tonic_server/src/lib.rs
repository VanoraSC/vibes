...
/// Generated gRPC service and types derived from the Protocol Buffer
/// definitions.
pub mod generated {
    tonic::include_proto!("message");
}

use generated::message_service_server::{MessageService, MessageServiceServer};

/// Re-export of the raw `Message` payload structure.
pub use generated::Message;
/// Re-export of the gRPC client for integration testing and potential
/// consumers.
pub use generated::message_service_client::MessageServiceClient;
